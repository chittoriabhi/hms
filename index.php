...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
        ...
        <div class="row">
          <div class="banner-info">
            ...
            <div class="banner-text text-center">
              ...
              <a href="#login-bar" class="btn btn-appoint">Make an Appointment.</a>
            </div>
            <div class="overlay-detail text-center">
              <a href="#login-bar"><i class="fa fa-angle-down"></i></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <!--/ banner-->
  <section id="login-bar" class="section-padding">
    <div class="container">
      <div class="box">
      <div class="row">
                  <div class="section group">
                      ...
                      <h3 class="ser-title">Patient Login</h3>
                      <i class="fa fa-ambulance"></i><br>
                      <a href="user_login.php" class="button btn btn-success" id="but"><h5 class="ser-title">Patient Login</h5></a>
                      </div>
          ...
          <div class="col-md-4 col-sm-4 icon">
              ...
              <h3 class="ser-title">Doctors Login</h3>
              <i class="fa fa-stethoscope"></i><br>
              <a href="doctor/doctor_login.php" class="button btn btn-success" id="but"><h5 class="ser-title">Doctor Login</h5></a>
          </div>
       


          <div class="col-md-4 col-sm-4 icon">
              <h3 class="ser-title">Admin Login</h3>
              <i class="fa fa-medkit"></i><br>
              <a href="admin" class="button btn btn-success" id="but"><h5 class="ser-title">Admin Login</h5></a>
